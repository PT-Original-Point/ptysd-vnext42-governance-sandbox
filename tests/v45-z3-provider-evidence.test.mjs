...
test('Z3 remains closed while current Z4 truth may wait on a later independently discovered resource gate', () => {
  ...
  assert.equal(z4run.wait_reason, 'WORKER_CHANNEL_ADMIN_READONLY_PRESTATE_REQUIRED');
