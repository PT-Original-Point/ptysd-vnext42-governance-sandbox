...
const expectedExports = [
  ...
  'EXECUTION_ATTEMPT_SCHEMA','EXECUTION_ATTEMPT_STATES','MUTATION_CLASSES','READBACK_STATES','SIDE_EFFECT_STATES',
  'TELEMETRY_SCHEMA','TELEMETRY_VERSION','VERIFIER_BINDING_SCHEMA',
  'admitVerifierOutcome','assertCapabilityCurrent','assertExecutionAttemptCurrent','beginExecutionDispatch','buildAdvisorPacket','classifyTelemetryBatch','compileCellCapability','createExecutionAttempt','createRetryExecutionAttempt',
  ...
  'fetchResearchSourceSafely','normalizeAdapterResult','projectStatus','projectStatusSafe','recordExecutionDispatchOutcome','recordExecutionReadback','redactTelemetryAttributes',
