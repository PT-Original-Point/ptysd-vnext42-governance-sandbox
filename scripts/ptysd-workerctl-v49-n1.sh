...
{"$schema":"https://opencode.ai/config.json","model":"opencode/muse-spark-1.3-contributor-free","small_model":"opencode/muse-spark-1.3-contributor-free","agent":{"title":{"disable":true}},"agents":{"build":{"permissions":[{"action":"*","resource":"*","effect":"ask"},{"action":"read","resource":".","effect":"allow"},{"action":"read","resource":"fixtures/v49-live-n1/src/slugify.mjs","effect":"allow"},{"action":"read","resource":"fixtures/v49-live-n1/test/slugify.test.mjs","effect":"allow"},{"action":"read","resource":"fixtures/v49-live-n1/package.json","effect":"allow"},{"action":"edit","resource":"fixtures/v49-live-n1/src/slugify.mjs","effect":"allow"}]}},"compaction":{"auto":false,"prune":false},"permission":{"*":"ask","read":{"*":"ask","fixtures/v49-live-n1/src/slugify.mjs":"allow","fixtures/v49-live-n1/test/slugify.test.mjs":"allow","fixtures/v49-live-n1/package.json":"allow"},"glob":"ask","grep":"ask","edit":{"*":"ask","fixtures/v49-live-n1/src/slugify.mjs":"allow"}}}
EOF
